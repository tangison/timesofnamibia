...
const PLACES: PlaceSeed[] = [
  ...
  // === Additional Parks & Reserves (10) ===
  { title: "Namib-Naukluft Park", type: "park", region: "Hardap" },
  { title: "Skeleton Coast Park", type: "park", region: "Kunene" },
  { title: "Cape Cross Seal Reserve", type: "park", region: "Erongo" },
  { title: "Popa Falls", type: "park", region: "Kavango East" },
  { title: "Mahango Game Reserve", type: "park", region: "Kavango East" },
  { title: "Salambala Conservancy", type: "park", region: "Zambezi" },
  { title: "Nyae Nyae Conservancy", type: "park", region: "Otjozondjupa" },
  { title: "Ehi-Rovipuka Conservancy", type: "park", region: "Kunene" },
  { title: "Torra Conservancy", type: "park", region: "Kunene" },
  { title: "Khoadi //Hoas Conservancy", type: "park", region: "Kunene" },

  // === Additional Landmarks (10) ===
  { title: "Burnt Mountain", type: "landmark", region: "Kunene" },
  { title: "Petrified Forest", type: "landmark", region: "Kunene" },
  { title: "Vingerklip", type: "landmark", region: "Kunene" },
  { title: "Okapuka Game Reserve", type: "landmark", region: "Khomas" },
  { title: "Lake Oanob", type: "landmark", region: "Hardap" },
  { title: "Naukluft Mountains", type: "landmark", region: "Hardap" },
  { title: "Kolmanskop Ghost Town", type: "landmark", region: "Karas" },
  { title: "Elizabeth Bay", type: "landmark", region: "Karas" },
  { title: "Hohenfriedeberg", type: "landmark", region: "Erongo" },
  { title: " Messum Crater", type: "landmark", region: "Erongo" },

  // === Additional Towns & Settlements (25) ===
  { title: "Helmeringhausen", type: "town", region: "Hardap" },
  { title: "Gibeon", type: "town", region: "Hardap" },
  { title: "Kalkrand", type: "town", region: "Hardap" },
  { title: "Maltahohe", type: "town", region: "Hardap" },
  { title: "Schlip", type: "town", region: "Hardap" },
  { title: "Asab", type: "town", region: "Hardap" },
  { title: "Tses", type: "town", region: "Karas" },
  { title: "Gruenau", type: "town", region: "Karas" },
  { title: "Ai-Ais", type: "town", region: "Karas" },
  { title: "Noordoewer", type: "town", region: "Karas" },
  { title: "Vioolsdrif", type: "town", region: "Karas" },
  { title: "Henties Bay", type: "town", region: "Erongo" },
  { title: "Uis", type: "town", region: "Erongo" },
  { title: "Omatjette", type: "town", region: "Erongo" },
  { title: "Walvis Bay Salt Works", type: "town", region: "Erongo" },
  { title: "Gochas", type: "town", region: "Hardap" },
  { title: "Stampriet", type: "town", region: "Hardap" },
  { title: "Ukwi", type: "town", region: "Karas" },
  { title: "Oniipa", type: "town", region: "Oshikoto" },
  { title: "Onayena", type: "town", region: "Oshikoto" },
  { title: "Omungwelume", type: "town", region: "Ohangwena" },
  { title: "Endola", type: "town", region: "Ohangwena" },
  { title: "Ogongo", type: "town", region: "Omusati" },
  { title: "Elim", type: "town", region: "Omusati" },
  { title: "Okalongo", type: "town", region: "Omusati" },

  // === Additional Wildlife (10) ===
  { title: "African elephant", type: "wildlife", region: "Kunene" },
  { title: "Honey badger", type: "wildlife", region: "Kunene" },
  { title: "Bat-eared fox", type: "wildlife", region: "Kunene" },
  { title: "Cape fox", type: "wildlife", region: "Hardap" },
  { title: "Caracal", type: "wildlife", region: "Kunene" },
  { title: "Black-backed jackal", type: "wildlife", region: "Erongo" },
  { title: "Klipspringer", type: "wildlife", region: "Kunene" },
  { title: "Steenbok", type: "wildlife", region: "Hardap" },
  { title: "Duiker", type: "wildlife", region: "Kavango East" },
  { title: "Wildebeest", type: "wildlife", region: "Otjozondjupa" },

  // === Additional Cultural (5) ===
  { title: "Independence Memorial Museum", type: "cultural", region: "Khomas" },
  { title: "Love of Christ Church (Windhoek)", type: "cultural", region: "Khomas" },
  { title: "Franz Hoine Haus", type: "cultural", region: "Erongo" },
  { title: "The Cape Cross", type: "cultural", region: "Erongo" },
  { title: "Namibia Craft Centre", type: "cultural", region: "Khomas" },
];
