...
export const metadata: Metadata = {
  title: "baster-rehoboth - Cultural Groups of Namibia",
  description: "History, language, and cultural practices of the baster-rehoboth people of Namibia.",
  alternates: { canonical: "/cultural-groups/baster-rehoboth" },
};

export const revalidate = 86400;

const CONTENT = `# baster-rehoboth
