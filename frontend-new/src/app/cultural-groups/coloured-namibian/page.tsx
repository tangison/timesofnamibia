...
export const metadata: Metadata = {
  title: "coloured-namibian - Cultural Groups of Namibia",
  description: "History, language, and cultural practices of the coloured-namibian people of Namibia.",
  alternates: { canonical: "/cultural-groups/coloured-namibian" },
};

export const revalidate = 86400;

const CONTENT = `# coloured-namibian
