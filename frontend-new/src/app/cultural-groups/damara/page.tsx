...
export const metadata: Metadata = {
  title: "damara - Cultural Groups of Namibia",
  description: "History, language, and cultural practices of the damara people of Namibia.",
  alternates: { canonical: "/cultural-groups/damara" },
};

export const revalidate = 86400;

const CONTENT = `# damara
