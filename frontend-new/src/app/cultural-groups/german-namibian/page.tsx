...
export const metadata: Metadata = {
  title: "german-namibian - Cultural Groups of Namibia",
  description: "History, language, and cultural practices of the german-namibian people of Namibia.",
  alternates: { canonical: "/cultural-groups/german-namibian" },
};

export const revalidate = 86400;

const CONTENT = `# german-namibian
