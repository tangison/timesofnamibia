...
export const metadata: Metadata = {
  title: "herero - Cultural Groups of Namibia",
  description: "History, language, and cultural practices of the herero people of Namibia.",
  alternates: { canonical: "/cultural-groups/herero" },
};

export const revalidate = 86400;

const CONTENT = `# herero
