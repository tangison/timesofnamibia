...
export const metadata: Metadata = {
  title: "himba - Cultural Groups of Namibia",
  description: "History, language, and cultural practices of the himba people of Namibia.",
  alternates: { canonical: "/cultural-groups/himba" },
};
