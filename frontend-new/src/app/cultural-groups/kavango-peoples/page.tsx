...
export const metadata: Metadata = {
  title: "kavango-peoples - Cultural Groups of Namibia",
  description: "History, language, and cultural practices of the kavango-peoples people of Namibia.",
  alternates: { canonical: "/cultural-groups/kavango-peoples" },
};

export const revalidate = 86400;

const CONTENT = `# kavango-peoples
