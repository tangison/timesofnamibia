...
export const metadata: Metadata = {
  title: "nama - Cultural Groups of Namibia",
  description: "History, language, and cultural practices of the nama people of Namibia.",
  alternates: { canonical: "/cultural-groups/nama" },
};
