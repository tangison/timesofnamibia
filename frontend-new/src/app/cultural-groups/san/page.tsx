...
export const metadata: Metadata = {
  title: "san - Cultural Groups of Namibia",
  description: "History, language, and cultural practices of the san people of Namibia.",
  alternates: { canonical: "/cultural-groups/san" },
};
