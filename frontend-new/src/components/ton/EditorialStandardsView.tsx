  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8 md:py-10">
      ...
      <div className="py-8 sm:py-10 text-center border-t border-b border-ton-black mb-8 sm:mb-10">
        <blockquote className="font-serif italic text-xl sm:text-2xl md:text-3xl text-ton-black/65 leading-relaxed max-w-3xl mx-auto">
          ...
          <div>
            <div className="bg-ton-black text-ton-cream p-5">
              ...
              <div className="mt-3 pt-3 border-t border-ton-cream/8">
                <p className="font-mono text-[9px] text-ton-cream/55 uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-5">
          {[
            ...
            <div key={i} className="pt-4 border-t border-ton-black/8">
              ...
              <p className="font-sans text-[11px] text-ton-black/55 mt-1 leading-relaxed">{item.note}</p>
            </div>
          ))}
        </div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={i} className="flex items-start gap-2.5">
                  ...
                  <span className="font-sans text-xs sm:text-sm text-ton-black/65 leading-relaxed">{item}</span>
                </li>
              ))}
            </ul>
          </div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={i}>
                  ...
                  <p className="font-serif text-sm text-ton-black/65 leading-relaxed mt-1">{item.desc}</p>
                </li>
              ))}
            </ul>
          </div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={i} className="flex items-start gap-2.5">
                  ...
                  <span className="font-sans text-xs sm:text-sm text-ton-black/65 leading-relaxed">{rule}</span>
                </li>
              ))}
            </ul>
          </div>
