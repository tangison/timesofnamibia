          ...
          >
            ...
            <div className="p-6 space-y-8">
                  ...
                  {NAV_SECTIONS.map((section, i) => (
                    ...
                    >
                      <div>
                        ...
                        <div className="text-xs text-ton-black/55 font-sans">
                          {section.desc}
                        </div>
                      </div>
                      <ArrowRight
                ...
                <div className="grid grid-cols-2 gap-2">
                  {TOOLS.map((tool, i) => (
                    ...
                    >
                      ...
                      <div className="text-[10px] text-ton-black/55 mt-1">
                        {tool.desc}
                      </div>
                    </motion.a>
                  ))}
              ...
              <div className="pt-6 border-t border-ton-black/10">
                <div className="flex items-center gap-2 text-ton-black/55 text-xs font-mono uppercase tracking-widest mb-3">
                  <Clock size={12} />
